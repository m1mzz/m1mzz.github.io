...
var _Faq = __webpack_require__(8);
...
var _EducationSystem = __webpack_require__(10);

var _EducationSystem2 = _interopRequireDefault(_EducationSystem);
...
function getConsultInit() {
  ...
  var $closeBtn = (0, _jquery2.default)('.popup-get-consalt__close');
  if (!$openBtn.length || !$modal.length || !$closeBtn.length) return;
  ...
  _createClass(Common, [{
    ...
    value: function menu() {
      ...
      burger.addEventListener('click', function () {
        ...
        $menu.add($menu.parent()).toggleClass('is-open');
      });
    }
  }, {
    key: 'headerWhite',
    value: function headerWhite() {
      var WHITE = 'bg-white';
      var flagWhite = false;
      function scrollHandler(e) {
        if (window.pageYOffset > 0) {
          if (!flagWhite) {
            flagWhite = true;
            _helpers.$header.addClass(WHITE);
          }
        } else if (flagWhite) {
          flagWhite = false;
          _helpers.$header.removeClass(WHITE);
        }
      }
      scrollHandler();
...
var Home = function () {
  ...
  _createClass(Home, [{
    ...
    key: 'initPackegeSlider',
    value: function initPackegeSlider() {
      var flkty = null;

      function flickityInit() {
        flkty = new Flickity('.packages__content__cards', {
          fade: true,
          pageDots: false,
          prevNextButtons: false,
          accessibility: false,
        ...
        (0, _jquery2.default)('.packages__controls__left').on('click', function () {
          flkty.previous();
        });
        (0, _jquery2.default)('.packages__controls__right').on('click', function () {
          flkty.next();
        });
      }
      if (_helpers.Resp.isMobile) flickityInit();
      var resizeTimer;
    ...
    key: 'initTestemonialsSlider',
    value: function initTestemonialsSlider() {
      var flkty = new Flickity('.testimonials__content', {
        fade: true,
        pageDots: false,
        prevNextButtons: false,
        accessibility: false,
      ...
      (0, _jquery2.default)('.testimonials__controls__left').on('click', function () {
        flkty.previous();
      });
      (0, _jquery2.default)('.testimonials__controls__right').on('click', function () {
        flkty.next();
      });
    }
  }, {
    ...
    value: function tabsInit() {
      (0, _Tabs2.default)('.what__tab', '.what__content-tab');
    }
  }, {
    key: 'headerToWhite',
    value: function headerToWhite() {
      _helpers.$header.addClass('bg-white');
    }
    ...
    value: function init() {
      this.initMainSlider();
      this.initPackegeSlider();
      this.initTestemonialsSlider();
      this.tabsInit();
      this.headerToWhite();
    }
  }]);
...
var Faq = function () {
  ...
  _createClass(Faq, [{
    key: 'acordionInit',
    value: function acordionInit() {
      var $faqItem = (0, _jquery2.default)('.faq__item');
      (0, _jquery2.default)('.faq').addClass('js');
      var hash = window.location.hash;
      var $currItem = (0, _jquery2.default)(hash).parent();

      if (hash) {
        $currItem.addClass('active').find('.faq__answer').slideDown();
      }
      ...
      function faqClickHandler(e) {
        ...
        var prevId = window.location.hash;
        var id = $this.attr('href');
        var url = window.location.href;
        var urlWithoutHash = url.split('#')[0];
        var newUrl = urlWithoutHash + id;

        if (prevId && id != prevId) (0, _jquery2.default)(prevId).parent().find('.faq__answer').stop(true, true).slideUp();
        $faqItem.removeClass('active');
        if (id != prevId) {
          history.replaceState(null, null, newUrl);
          $parent.find('.faq__answer').slideDown();
          $parent.stop(true, true).addClass('active');
        } else {
      ...
      (0, _jquery2.default)('.faq__question').on('click tap', faqClickHandler);
    }
    /**
     * Initialize Home page scripts.
     */
...
var Home = function () {
  ...
  _createClass(Home, [{
    key: 'tabsInit',
    value: function tabsInit() {
      (0, _Tabs2.default)('.services-services__tab', '.services-services__content-tab');
    }
...
var Home = function () {
  ...
  _createClass(Home, [{
    key: 'tabsInit',
    value: function tabsInit() {
      (0, _Tabs2.default)('.education_tabs__tab', '.education_tabs__content-tab');
    }
